...
<?php 
$validTest = array("userName" => "krobbins", "password" =>"somerandompassword");
...
<?php 
$invalidTest = array("userName" => "jwachter$");
...
<h2>It should have an error when the user name or password is empty</h2>
<?php 
$invalidTest = array("userName" => "", "password" => "");
$s1 = new User($invalidTest);
$test2 = (empty($s1->getErrors()))?'':
'Failed:It should have errors when invalid input is provided<br>';
echo $test2;
